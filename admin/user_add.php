                ...
                <div class="col-lg-12 mt ">
                    <?php  
                     if (isset($_POST['create_post'])) {
                      ...
                      $add_post_query =  "INSERT INTO `posts` (`post_category_id`, `post_title`, `post_author`, `post_date`, `post_image`, `post_content`, `post_tags`, `post_comment_count`, `post_status`) VALUES ('$post_category_id','$post_title','$post_author','$post_date','$post_image','$post_content','$post_tags','$post_comment_count','$post_status')";  
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <input type="date" name="post_date" class="form-control"
                                        id="exampleFormControlInput1" placeholder="Enter Post Date" required>
                                </div>
                            </div>
                        </div>
                       <div class="form-group">
                        ...
                        <input type="submit" name="create_post" class="form-control"
                                        id="exampleFormControlInput1" placeholder="Submit" required>
                    </form>
                </div>
                <!-- /.col-lg-6 -->
